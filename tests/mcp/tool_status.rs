...
fn mcp_tool_status_mixed() {
    ...
    create_specre_card(&dir, "docs/specres", "cli/a.md", "01AAAAAAAAAAAAAAAAAAAAAAAA", "card_a", "draft");
    create_specre_card(&dir, "docs/specres", "cli/b.md", "01BBBBBBBBBBBBBBBBBBBBBBBB", "card_b", "stable");
    create_specre_card(&dir, "docs/specres", "cli/c.md", "01CCCCCCCCCCCCCCCCCCCCCCCC", "card_c", "deprecated");
...
fn mcp_tool_status_custom_threshold() {
    ...
    dir.child("docs/specres/cli/recent.md").write_str(content).unwrap();
