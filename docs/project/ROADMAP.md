...
<details>
<summary>Completed versions (v0.1–v0.5)</summary>
...
- [x] `specre init` extended — Include `[health-check] drifts = 10`, `[drift] grace_days = 7` as a commented-out default in the generated `specre.toml`
