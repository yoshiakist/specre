...
- **v0.4 — Command Usability Improvements** ✅ `destroy`, `exclude_patterns`, richer `specre.toml` defaults
- **v0.5 — Drift Detection** — `drift`, `verify`, `reopen`, GitHub Actions template
- **v0.6 — QA Support** — `impact`, `diff`, `export`
